								...
								<div class="col-xl-4 col-sm-12">
									<div class="form-group">
										...
										<input type="date" class="form-control" id="check_in_date"
											   name="check_in_date" placeholder="Check In Date" min="<?= DATE_NOW; ?>" required autofocus>
									</div>
								</div>
								<div class="col-xl-4 col-sm-12">
									<div class="form-group">
...
<!--											   name="check_out_date" placeholder="Check Out Date" min="--><?php //= DATE_NOW; ?><!--" data-date-format="dd/mm/yyyy" required>-->

										<input type="date" class="form-control" id="check_out_date"
											   name="check_out_date" placeholder="Check Out Date" min="<?= DATE_NOW; ?>" required>
									</div>
								</div>
