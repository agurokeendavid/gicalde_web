				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="view_name">Room Name</label>
					...
					<div class="col-sm-12">
						<div class="form-group">
							<label for="view_no_of_houses">No. of Houses</label>
							<input type="number" class="form-control" id="view_no_of_houses" name="view_no_of_houses" placeholder="No. of Houses"
								   readonly>
						</div>
					</div>
					<div class="col-sm-12">
					...
					<div class="col-sm-12">
						<div class="form-group">
							<label for="view_no_of_rooms">No. of Rooms</label>
							<input type="number" class="form-control" id="view_no_of_rooms" name="view_no_of_rooms" placeholder="No. of Rooms"
								   readonly>
						</div>
					</div>
					<div class="col-sm-12">
